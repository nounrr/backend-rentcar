    ...
    <Card className="cursor-pointer">
      <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4">
        <div>
          ...
          <CardDescription>Dernieres transactions clients</CardDescription>
        </div>
            ...
            <div className="flex p-3 rounded-lg border gap-2">
              ...
              <div className="flex flex-1 items-center flex-wrap justify-between gap-1">
                ...
                <div className="flex items-center space-x-3">
                  <Badge
                    variant={
                      transaction.status === "terminee" ? "default" :
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                      <DropdownMenuItem className="cursor-pointer">Voir le detail</DropdownMenuItem>
                      <DropdownMenuItem className="cursor-pointer">Telecharger le recu</DropdownMenuItem>
                      <DropdownMenuItem className="cursor-pointer">Contacter le client</DropdownMenuItem>
                    </DropdownMenuContent>
                  </DropdownMenu>
                </div>
              </div>
