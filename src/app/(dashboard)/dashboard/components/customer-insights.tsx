...
const regionsData = [
  { region: "Amerique du Nord", customers: 6847, revenue: "$847,523", growth: "+12.3%", growthColor: "text-green-600" },
  { region: "Europe", customers: 4521, revenue: "$563,891", growth: "+9.7%", growthColor: "text-green-600" },
  { region: "Asie-Pacifique", customers: 2892, revenue: "$321,456", growth: "+18.4%", growthColor: "text-blue-600" },
  { region: "Amerique latine", customers: 1123, revenue: "$187,234", growth: "+15.8%", growthColor: "text-green-600" },
  { region: "Autres", customers: 464, revenue: "$67,891", growth: "+5.2%", growthColor: "text-orange-600" },
]
...
export function CustomerInsights() {
  ...
  return (
    <Card className="h-fit">
      <CardHeader>
        <CardTitle>Apercu clients</CardTitle>
        <CardDescription>Croissance, profils et zones geographiques</CardDescription>
      </CardHeader>
      <CardContent>
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            ...
            <div className="grid gap-6">
              <div className="grid grid-cols-10 gap-6">
                <div className="col-span-10 xl:col-span-7">
                  <h3 className="text-sm font-medium text-muted-foreground mb-6">Evolution de la clientele</h3>
                  <ChartContainer config={chartConfig} className="h-93.75 min-w-0 w-full">
                ...
                <div className="col-span-10 xl:col-span-3 space-y-5">
                  <h3 className="text-sm font-medium text-muted-foreground mb-6">Indicateurs cles</h3>
                  <div className="grid grid-cols-3 gap-5">
                    <div className="p-4 rounded-lg max-lg:col-span-3 xl:col-span-3 border">
                      <div className="flex items-center gap-2 mb-2">
                        <TrendingUp className="h-4 w-4 text-primary" />
                        <span className="text-sm font-medium">Clients totaux</span>
                      </div>
                      <div className="text-2xl font-bold">15,847</div>
                      <div className="text-xs text-green-600 flex items-center gap-1 mt-1">
                        <ArrowUpIcon className="h-3 w-3" />
                        +12.5% vs le mois dernier
                      </div>
                    </div>
                    ...
                    <div className="p-4 rounded-lg max-lg:col-span-3 xl:col-span-3 border">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-sm font-medium">Taux de retention</span>
                      </div>
          ...
          <TabsContent value="demographics" className="mt-8">
              ...
              <Table>
                <TableHeader>
                  <TableRow className="border-b">
                    <TableHead className="py-5 px-6 font-semibold">Tranche d'age</TableHead>
                    <TableHead className="text-right py-5 px-6 font-semibold">Clients</TableHead>
                    <TableHead className="text-right py-5 px-6 font-semibold">Part</TableHead>
                    <TableHead className="text-right py-5 px-6 font-semibold">Croissance</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
            ...
            <div className="flex items-center justify-end space-x-2 py-6">
              <div className="text-muted-foreground text-sm hidden sm:block">
                0 sur {demographicsData.length} ligne(s) selectionnee(s).
              </div>
          ...
          <TabsContent value="regions" className="mt-8">
              ...
              <Table>
                <TableHeader>
                  <TableRow className="border-b">
                    ...
                    <TableHead className="text-right py-5 px-6 font-semibold">Clients</TableHead>
                    <TableHead className="text-right py-5 px-6 font-semibold">CA</TableHead>
                    <TableHead className="text-right py-5 px-6 font-semibold">Croissance</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
            ...
            <div className="flex items-center justify-end space-x-2 py-6">
              <div className="text-muted-foreground text-sm hidden sm:block">
                0 sur {regionsData.length} ligne(s) selectionnee(s).
              </div>
              <div className="space-x-2 space-y-2">
                <Button variant="outline" size="sm" disabled>
                  Precedent
