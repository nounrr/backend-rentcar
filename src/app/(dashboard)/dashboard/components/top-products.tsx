            ...
            <div className="flex gap-2 items-center justify-between space-x-3 flex-1 flex-wrap">
              <div className="">
                ...
                <div className="flex items-center space-x-2 mt-1">
                  ...
                  <span className="text-xs text-muted-foreground">{product.sales} ventes</span>
                </div>
              </div>
