  ...
  return (
    <div className='mx-auto flex min-h-dvh flex-col items-center justify-center gap-8 p-8 md:gap-12 md:p-16'>
      ...
      <div className='text-center'>
        ...
        <h2 className="mb-3 text-2xl font-semibold">Erreur interne du serveur</h2>
        <p>Un incident est survenu de notre cote. Nous travaillons a corriger le probleme. Veuillez reessayer plus tard.</p>
